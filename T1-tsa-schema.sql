...
ALTER TABLE booking ADD CONSTRAINT booking_unique UNIQUE ( resort_id, cabin_no, booking_from );
...
ALTER TABLE cabin ADD CONSTRAINT cabin_bedroomnocheck CHECK (cabin_nobedrooms BETWEEN 1 AND 4); 

ALTER TABLE cabin ADD CONSTRAINT cabin_bedroomtypecheck CHECK (cabin_bathroom_type in ('I', 'C')); 
                        

-- Add all missing FK Constraints below here

ALTER TABLE booking
    ADD CONSTRAINT booking_fk FOREIGN KEY ( resort_id, cabin_no )
...
ALTER TABLE cabin
    ADD CONSTRAINT cabin_resort_fk FOREIGN KEY ( resort_id )
